...
2026-10-01 対話セッション準備 🔬
- `docs/dialogs/20261001/index.html` 作成済み（次回の主軸メモ）
  - 主軸：新自由主義30年の弊害の検証 — 特に「新自由主義的な考え方 → 非正規雇用拡大」の因果関係
  - 発信方針：因果関係を明確にした上で、結果として生じている弊害を分かりやすく発信する
  - 対話の目標：現代社会の問題に経済学的視点から「我々に何ができるか」を考え、改善の方向に影響を及ぼす
...
### 2026-09-03 — 対話セッション ✅
- 気候変動・巨大データセンター・「剰女」トピックに加え、非正規雇用問題が主要論点に
- 本荘さんの強い問題意識を確認：新自由主義30年の弊害、特に「新自由主義 → 非正規雇用拡大」の因果関係
- 次回（2026-10-01）はこの因果関係の検証を主軸に据える方針を確認
